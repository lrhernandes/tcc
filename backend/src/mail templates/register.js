module.exports = {
    registerEmail (firstName){
        const str = `<body style="position: relative; text-align:justify; width: 80%">
                        ...
                        <p>Uma infinidade de bichinhos está disponível para adoção na plataforma. Habilite sua localização e encontre os mais próximos de você! Crie anúncios personalizados e localize uma ótima família para os bicnhinhos que cuida, e o melhor: de forma segura. 🐝</p>
